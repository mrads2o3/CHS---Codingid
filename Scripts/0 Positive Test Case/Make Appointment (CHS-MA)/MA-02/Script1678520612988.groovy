...
WebUI.waitForElementVisible(findTestObject('Page_CURA Healthcare Service/section_Make Appointment                   _57f49e'), 
    0)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_CURA Healthcare Service/section_Appointment Confirmation           _5b3155'), 
    0)
...
WebUI.verifyMatch(WebUI.getUrl(), 'https://katalon-demo-cura.herokuapp.com/', false)
